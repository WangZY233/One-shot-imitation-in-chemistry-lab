...
from gpt_ability import get_instrument_category
...
IMG_PATH = "../Result_Video2Ro_Chem/input/images/test2.jpg"
...
OUTPUT_DIR = Path("../Result_Video2Ro_Chem/outputs/instruments_detector")
...
if WITH_SLICE_INFERENCE:
    ...
    print(f"Detected boxes: {input_boxes}")
